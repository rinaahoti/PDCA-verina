        ...
        <div style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--color-bg)' }}>
            <div className="card" style={{ width: '400px', padding: '3rem' }}>
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <button type="submit" className="btn" style={{ width: '100%', marginTop: '1.5rem', padding: '0.75rem', justifyContent: 'center', background: '#5FAE9E', color: '#cbeee2', border: 'none' }}>Sign In</button>
                </form>
