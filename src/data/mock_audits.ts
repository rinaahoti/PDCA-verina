...
export const MOCK_FINDINGS: AuditFinding[] = [
    ...
    { id: 'F-015', title: 'Isolation protocol breach in ICU', rating: 'Major', location: 'University Hospital Basel (BS)', responsible: 'Julia Chen', assigned: 'ICU Staff', status: 'PLAN', deadline: '2026-03-10', cause: 'Lack of PPE Train', auditId: 'AUD-2026-004', auditName: 'Infection Control Site Visit', auditType: 'Process', createdAt: '2026-02-20' },
